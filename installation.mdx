...
QitOS requires **Python 3.9 or later**. It is tested on Python 3.9, 3.10, 3.11, and 3.12.
...
<Tip>
If you're just getting started, `pip install "qitos[models]"` is the right choice. It gives you everything you need to run the quickstart examples.
</Tip>
...
You can also verify the `qita` CLI is on your path:
