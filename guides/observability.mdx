...
This is the board view you will use most often when comparing runs:
...
The trajectory view is where parser behavior, tool calls, and step timing become easy to inspect:
