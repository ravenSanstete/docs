...
QitOS v0.5 now has a first official provider-neutral **computer-use lane** for desktop and GUI work.
...
The current implementation now ships the first official desktop starter benchmark path, the separate `osworld` benchmark adapter layer, and the qita visual inspection surface.
